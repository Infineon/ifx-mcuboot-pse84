...
/**
 * \brief Compares masks of two FIH variables.
 *
 * \param a_msk  mask of the 1st fih_int value.
 * \param b_msk  mask of the 2nd fih_int value.
 *
 * \return   TRUE if masks are equal
 *           otherwise FALSE.
 *
 ******************************************************************************/
 __attribute__((noinline)) bool fih_check_eq_int_mask(int32_t a_msk, int32_t b_msk);

 /**
 * \brief Compares masks of two FIH variables.
 *
 * \param a_msk  mask of the 1st fih_uint value.
 * \param b_msk  mask of the 2nd fih_uint value.
 *
 * \return   TRUE if masks are equal
 *           otherwise FALSE.
 *
 ******************************************************************************/
 __attribute__((noinline)) bool fih_check_eq_uint_mask(uint32_t a_msk, uint32_t b_msk);
 ...
 *
 ******************************************************************************/
 __attribute__((noinline)) bool fih_check_not_eq_int_mask(int32_t a_msk, int32_t b_msk);
 ...
 *
 ******************************************************************************/
 __attribute__((noinline)) bool fih_check_not_eq_uint_mask(uint32_t a_msk, uint32_t b_msk);
...
#define fih_eq(x, y) \
        ( ((x).val == (y).val) && \
          fih_delay() && \
          ((y).val == FIH_INT_VAL_MASK((x).msk)) && \
          fih_delay() && \
          fih_int_validate(x) && \
          fih_check_eq_int_mask(((x).msk), ((y).msk)) \
        )
...
#define fih_uint_eq(x, y) \
        ( ((x).val == (y).val) && \
          ...
          fih_delay() && \
          fih_uint_validate(x) && \
          fih_check_eq_uint_mask(((x).msk), ((y).msk)) \
        )
...
#define fih_not_eq(x, y) \
        ( ((x).val != (y).val) && \
          ...
          fih_delay() && \
          fih_int_validate(x) && \
          fih_check_not_eq_int_mask(((x).msk), ((y).msk)) \
        )
...
#define fih_uint_not_eq(x, y) \
        ( ((x).val != (y).val) && \
          ...
          fih_delay() && \
          fih_uint_validate(x) && \
          fih_check_not_eq_uint_mask(((x).msk), ((y).msk)) \
        )
